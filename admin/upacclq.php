...
if(isset($_POST['upacc'])):
	...
	if(!isset($_POST['rank'],$_POST['anhthongtin'],$_POST['thongtin'],$_POST['gia'],$_POST['giaatm'])){
...
<div class="panel panel-default">
  <div class="panel-heading">Thêm tài khoản liên quân</div>
  <div class="panel-body">


<form action ="?nhincc=upacclq" method="post" enctype="multipart/form-data">
