...
if(isset($_POST['upacc'])):
	...
	if(!isset($_POST['anhthongtin'],$_POST['thongtin'],$_POST['gia'],$_POST['giaatm'])){
...
<div class="panel panel-default">
  <div class="panel-heading">Thêm tài khoản upacccf</div>
  <div class="panel-body">


<form action ="?nhincc=upacccf" method="post" enctype="multipart/form-data">
	...
	<select class="form-control" name="loainick" id="loainick">
		...
		<div class="col-md-4">
	            ...
	            <div class="col-md-12">
	                <div class="form-group">
	                <label>Thông Tin Acc</label>
	                <input class="form-control" placeholder="Tình Trạng Acc" id="thongtin" name="thongtin" type="text" value="">
	              </div>
	            </div>
