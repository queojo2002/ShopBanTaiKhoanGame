                    ...
                    <div class="box box-danger collapsed-box box-solid" style="padding: 0;">
                        <div class="box-header with-border">
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active"><a data-toggle="tab" href="#top10" aria-expanded="true"><h3 class="box-title">TOP NẠP THẺ</h3></a></li>
                            ...
                            <div class="tab-content">
                                <div id="top10" class="tab-pane fade active in">
                                    <div id="evenstop10" style="color: #505050;">
                                                    ...
                                                    <div class="col-xs-8" style="padding-right: 0px;">
                                                        ...
                                                        <span class="fa-stack"><span class="fa fa-circle fa-stack-2x color color_1"></span><strong class="fa-stack-1x" style="color:white;">1</strong></span><img src="/people.png" class="img-top" alt="" title="" media-simple="true">hai0097
                                                        </label>
                                                    </div>
                                                    <div class="col-xs-4" style="text-align: right;">
                                                        <label class="control-label"><button type="button" class="btn btn-danger tops">20,000</button></label>
                                                    </div>
                                                </div>
                                                                                            <div class="row">
                                                    <div class="col-xs-8" style="padding-right: 0px;">
                                                        <label class="control-label">
                                                        <span class="fa-stack"><span class="fa fa-circle fa-stack-2x color color_2"></span><strong class="fa-stack-1x" style="color:white;">2</strong></span><img src="/people.png" class="img-top" alt="" title="" media-simple="true">Kendybao289
                                                        </label>
                                                    </div>
                                                    <div class="col-xs-4" style="text-align: right;">
                                                        <label class="control-label"><button type="button" class="btn btn-danger tops">10,000</button></label>
                                                    </div>
                                                </div>
                                                                                            <div class="row">
                                                    <div class="col-xs-8" style="padding-right: 0px;">
                                                        <label class="control-label">
                                                        <span class="fa-stack"><span class="fa fa-circle fa-stack-2x color color_3"></span><strong class="fa-stack-1x" style="color:white;">3</strong></span><img src="/people.png" class="img-top" alt="" title="" media-simple="true">ngochai2706
                                                        </label>
                                                    </div>
                                                    <div class="col-xs-4" style="text-align: right;">
                                                        <label class="control-label"><button type="button" class="btn btn-danger tops">10,000</button></label>
                                ...
                                <div id="phanthuong" class="tab-pane fade in">
                                    <div class="box-body" style="color: #505050;padding:20px;min-height: 480px;line-height: 2;">
                                        <p>Chốt vào cuối tháng 30-6<br>
-Top 1: 200k</p>

<p>-Top 2: 100k</p>

<p>-Top 3: 50k<br>
Chỉ tính khi nạp trên 500k</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="box box-danger collapsed-box box-solid" style="padding: 0;">
                        ...
                        <div class="box-body" style="color: #505050;padding:20px;min-height: 480px;line-height: 2;">
                            ...
                            <div id="LogDonate" data-page="1"><div id="tb_hisser_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_scroll">
                                    ...
                                    <table id="tb_hisser" class="table-bordered table-striped table-condensed cf dataTable no-footer" style="width: 513px; line-height: 2;" role="grid">
                                        <thead class="cf">
                                            <tr role="row" style="height: 0px;">
                                                <th class="f-xs sorting_disabled" align="left" data-title="Nhân Vật" rowspan="1" colspan="1" style="width: 218px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;"><div class="dataTables_sizing" style="height:0;overflow:hidden;">Nhân Vật</div>
                                                </th>
                                                <th class="f-xs sorting_disabled" align="left" data-title="Giao dịch" rowspan="1" colspan="1" style="width: 279px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;">
                                                    <div class="dataTables_sizing" style="height:0;overflow:hidden;">Giao dịch</div></th>
                                            </tr>
                                        </thead>
                                        <tbody>
