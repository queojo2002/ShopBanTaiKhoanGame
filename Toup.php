		...
		<div class="col-md-12 col-sm-6 col-xs-6 m-t-15">
			...
			<div class="c-content-ver-nav m-b-20">
                ...
                <div class="c-content-title-1">
                    ...
                    <!-- <p style="text-align: center;color: red">*Tỉ lệ nạp thẻ 1:1</p> -->
                    <p style="text-align: center;color: red">*Chú ý: Nạp thẻ sai mệnh giá mất 100% giá trị thẻ.</p>
                     <!--<p style="text-align: center;color: red">*Cộng 30% giá trị nạp thẻ khi nạp qua Momo hoặc Atm.</p> -->
                    <form method="POST" action="Toup-Ajax.php" accept-charset="UTF-8" class="form-horizontal form-charge">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Tài khoản:</label>
                        <div class="col-md-6">
                            <input class="form-control c-square c-theme" type="text"
                                   value="<?php echo $_SESSION['username_login']; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control  c-square c-theme" name="info_loaithe" id="info_loaithe">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control  c-square c-theme" name="info_menhgia" id="info_menhgia">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control  c-square c-theme " name="info_mathe" type="text" maxlength="16"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input class="form-control c-square c-theme " name="info_seri" type="text" maxlength="16"
                                   required placeholder=""
                                   required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group c-margin-t-40">
                        <div class="col-md-offset-3 col-md-6">
                            <button name="napthe" type="submit" class="btn btn-submit c-theme-btn c-btn-square c-btn-uppercase c-btn-bold btn-block" data-loading-text="<i class='fa fa-spinner fa-spin '></i>">Nạp thẻ
                            </button>
                            <script>
...
<div class="alert alert-info">
                        <p>
						<span style="color:#e74c3c"><strong>LƯU Ý : Chọn Đúng Mệnh Giá Thẻ . Chọn Sai Mệnh Giá&nbsp;Thẻ&nbsp;Bị Trừ 100% Không Được Hoàn Tiền.</strong></span></p>
						<p>Nạp bằng MoMo - ATM - Ví Điện Tử tỷ lệ 1 :1</p>
                    </div>
